...
| 参数 | 类型 | 必填 | 说明 |
|------|------|------|------|
| model | string | 是 | 模型：`gpt-image-1.5` \| `gemini-3-pro-image-preview-4k-vip` \| `doubao-seedream-4-5-251128` \| `kling-v1-5` |
| prompt | string | 是 | 文本提示词 |
| image | string[] | 否 | 参考图 URL 数组，默认 `[]` |
| n | number | 否 | 生成数量，默认 1 |
| size | string | 否 | 尺寸，见下方「尺寸说明」 |
| quality | string | 否 | 分辨率：gpt 为 `standard` \| `hd`；gemini 为 `1k` \| `2k` \| `4k`；即梦/可灵无此参数 |
...
- **gemini-3-pro-image-preview-4k-vip**：`1x1`、`2x3`、`3x2`、`3x4`、`4x3`、`4x5`、`5x4`、`9x16`、`16x9`、`21x9`
...
- gemini-3-pro-image-preview-4k-vip：size 1x1～21x9，quality 1k/2k/4k  
