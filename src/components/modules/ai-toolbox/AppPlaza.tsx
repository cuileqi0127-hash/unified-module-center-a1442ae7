...
import { Eye, Copy, TrendingUp, Megaphone, UserCircle, Video, BarChart3, Film } from 'lucide-react';
...
export function AppPlaza({ onNavigate }: AppPlazaProps) {
  ...
  const marketInsightTools = [
    ...
    { id: 'tiktok-trending-video', titleKey: 'appPlaza.tools.tiktokTrendingVideo.title', descKey: 'appPlaza.tools.tiktokTrendingVideo.description', icon: <Film className="w-5 h-5 text-muted-foreground" />, views: 389, copies: 76 },
  ];
